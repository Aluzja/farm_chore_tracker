...
must_haves:
  truths:
    - "Photos upload to cloud storage when online"
    - "Completed chore photos are viewable in the UI"
    - "Admin can configure which chores require photo proof"
    - "Daily chores inherit photo requirement from master"
  artifacts:
