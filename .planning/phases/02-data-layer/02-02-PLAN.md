...
export const create = mutation({
  args: {
    _id: v.string(), // Client-generated ID for offline support
    text: v.string(),
    isCompleted: v.boolean(),
    completedAt: v.optional(v.string()),
    completedBy: v.optional(v.string()),
  ...
  handler: async (ctx, args) => {
    ...
    // Note: We store client _id in a field, Convex generates its own _id
...
Key patterns:
- Client-generated _id for offline creation
  ...
  private async applyMutation(mutation: Mutation): Promise<void> {
    ...
    switch (type) {
      case 'create':
        ...
        await this.markLocalSynced(payload._id as string);
        break;
